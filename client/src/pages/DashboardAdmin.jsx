...
import MenuManagement from "../components/DashComponents/MenuManagementAdmin";
...
const DashboardAdmin = () => {
  ...
  const Dash=[<MenuManagement/>,<InventoryManagement/>];
  const [currentDash, setCurrentDash] = useState(<MenuManagement/>);
  ...
  <div className="drawer-side">
    ...
    <li><a className="btn btn-ghost normal-case font-bold text-3xl mb-8 mt-2">
      ...
      <li className="text-lg font-medium "><a onClick={()=>{setCurrentDash(Dash[0])}}>Menu Management</a></li>
      <li className="text-lg font-medium "><a onClick={()=>{setCurrentDash(Dash[1])}}>Inventory Management</a></li>
